...
import 'package:edtech/core/constants/server/retry_on_error_constants.dart';
...
class RetryOnErrorInterceptor extends BaseInterceptor {
  ...
  Future<void> onError(
    ...
    assert(
      err.requestOptions.headers[_retryCountKey] != null,
      'Retry count must be set in request headers',
    );
